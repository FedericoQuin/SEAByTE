...
public class StudentTest extends StatisticalTest<Double> {
    
    public StudentTest(NullHypothesis<Double> nullHypothesis, double pValue, int samples, String resultingVariableName,
    ...
    public String toHtmlString() {
        return String.format("Student t-test: [<br>&nbsp;&nbsp;&nbsp;&nbsp;%s,<br>&nbsp;&nbsp;&nbsp;&nbsp;p=%.3f, n=%d<br>]", 
